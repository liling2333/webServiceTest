...
public class ObjectFactory {
    ...
    private final static QName _GetPersonById_QNAME = new QName("http://outputService.web.com/", "getPersonById");
    private final static QName _GetPersonByIdResponse_QNAME = new QName("http://outputService.web.com/", "getPersonByIdResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://outputService.web.com/", name = "getPersonById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://outputService.web.com/", name = "getPersonByIdResponse")
